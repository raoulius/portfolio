...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  const handleWheel = (e: React.WheelEvent<HTMLDivElement>) => {
    ...
    // If scrolling vertically (deltaY), let the page handle it
    if (Math.abs(e.deltaY) > Math.abs(e.deltaX)) {
      return; // Allow vertical scrolling to bubble up to the page
    }

    // If scrolling horizontally (deltaX), handle it in the carousel
    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800 disabled:opacity-50 border border-neutral-700"
            onClick={scrollLeft}
    ...
    <>
      ...
      */}
      <motion.button
        ...
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-neutral-900 md:h-[40rem] md:w-96 cursor-pointer"
      >
